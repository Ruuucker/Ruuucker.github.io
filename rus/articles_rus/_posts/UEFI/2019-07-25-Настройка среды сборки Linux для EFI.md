...
Для этого откройте HelloEfi.dsc в любимом текстовом редакторе и прокрутите вниз до раздела [Components]. В этом разделе добавьте путь из папки edk2 в файл inf, как показано ниже:
