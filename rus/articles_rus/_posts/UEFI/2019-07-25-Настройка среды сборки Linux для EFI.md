...
Первым шагом в настройке среды разработки является установка UDK, в данном случае TianoCore EDK II [http://www.tianocore.org/edk2](http://www.tianocore.org/edk2). Это среда с открытым исходным кодом для разработки UEFI и PI.
